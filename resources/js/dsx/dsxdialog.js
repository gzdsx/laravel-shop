function DSXDialog(settings) {
    ...
    this.id = options.id ? options.id : 'dialog_'+DSXDialog.__count++;
    var $this = this;
    var footer = '<div class="modal-footer">\n' +
        '                    <button type="button" class="btn btn-secondary d-btn-cancel">'+options.buttonCancelText+'</button>\n' +
        '                    <button type="button" class="btn btn-primary d-btn-confirm">'+options.buttonConfirmText+'</button>\n' +
        '        </div>';
