<template>
    <admin-frame>
        ...
        <div class="mainframe-content">
            <div class="content-block">
                <header class="table-edit-header">
                    <div class="display-flex">
                        <div class="font-16 font-bold flex">
                            <span>菜单列表</span>
                            <p class="font-12 font-normal">最多仅支持三个一级菜单和5个二级菜单</p>
                        </div>
                ...
                <template v-if="itemList.length>0">
                    <div v-for="(item,idx1) in itemList" :key="idx1">
                        <table class="dsxui-listtable">
                            <colgroup>
                                <col>
                                <col width="300">
        ...
        <el-dialog title="编辑菜单" closeable :visible.sync="showDialog">
