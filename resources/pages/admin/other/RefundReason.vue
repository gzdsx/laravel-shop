        ...
        <header class="page-header">
            <div class="flex">
                <el-breadcrumb separator="/">
                    ...
                    <el-breadcrumb-item>退货理由</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
        </header>
        ...
        <el-dialog title="编辑信息" closeable :visible.sync="showDialog">
            <table class="dsxui-formtable">
                ...
                <tr>
                    ...
                    <td class="cell-input">
                        <el-input size="medium" v-model="reason.displayorder"></el-input>
                    </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            fetchList: function () {
                this.$get('/admin/refundreason/getall').then(response => {
                    this.itemList = response.data.items;
                });
            },
            handleUpdate(cb) {
                this.$post('/admin/refundreason/update', {
                    id: this.reason.id,
                    reason: this.reason
                }).then(response => {
                    this.resetData();
            ...
            handleDelete(id) {
                ...
                this.$confirm('此操作将永久删除所选信息, 是否继续?', '提示', {
                    ...
                    this.$post('/admin/refundreason/delete', {items}).then(response => {
                        this.fetchList();
                    });
                });
            },
