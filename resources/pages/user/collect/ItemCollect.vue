    ...
    <div class="content-block">
        ...
        <div class="dsxui-tabs-container">
            <ul class="dsxui-tabs">
                ...
                <li class="tab-item">
                    <router-link to="/collect/item" class="tab-link active">商品</router-link>
                </li>
            </ul>
        </div>
        ...
        <section class="section">
            <table class="dsxui-listtable">
                ...
                <tr v-for="(item,index) in itemList" :key="index">
                    ...
                    <td>
                        <h3 class="title"><a :href="item.item.url" target="_blank">{{item.title}}</a></h3>
                    </td>
...
<script>
    export default {
        ...
        methods:{
            fetchList(){
                this.$get('/user/collect/item/batchget',{
                    q:this.q,
                    offset:this.offset
                }).then(response=>{
            ...
            handleDelete(id){
                this.$post('/user/collect/item/delete',{id}).then(response=>{
                    this.fetchList();
                });
            },
