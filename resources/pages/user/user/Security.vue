<template>
    <div class="content-block">
        ...
        <el-dialog title="绑定手机号" :visible.sync="showMobile" width="500px">
            <table class="dsxui-formtable">
                <colgroup>
                    <col class="w60">
                    <col class="w300">
        ...
        <el-dialog title="绑定邮箱" :visible.sync="showEmail" width="500px">
            <table class="dsxui-formtable">
                <colgroup>
                    <col class="w60">
                    <col class="w300">
        ...
        <el-dialog title="修改密码" :visible.sync="showPass" width="500px">
            <table class="dsxui-formtable">
                <colgroup>
                    <col class="w60">
                    <col class="w300">
    ...
    export default {
        ...
        methods: {
            ...
            handleSaveMobile() {
                ...
                this.$post('/user/security/update_mobile', {mobile: this.mobile}).then(response => {
            ...
            handleSaveEmail() {
                ...
                this.$post('/user/security/update_email', {email: this.email}).then(response => {
                    if (response.data.errcode) {
                        this.$showToast(response.data.errmsg);
                    } else {
            ...
            handleSavePassword() {
                ...
                this.$post('/user/security/update_password', {
