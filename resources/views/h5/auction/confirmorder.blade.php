...
<div class="auction" id="auction">
    <form method="post" action="{{url('h5/auction/settlement')}}" id="orderFrm">
        @csrf
        ...
        <div class="weui-cells margin-top-0">
            <div class="weui-cell weui-cell_access">
                ...
                <div class="weui-cell__ft fontsize-14">快递 免邮</div>
            </div>
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <textarea class="weui-textarea fontsize-14" rows="3" placeholder="买家留言： 选填，填写内容已和卖家协商确认"></textarea>
                </div>
            </div>
        </div>
        <div class="blank"></div>
