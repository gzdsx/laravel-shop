...
var _default = {
  ...
  methods: {
    ...
    onCheckAll: function onCheckAll() {
      if (this.checked) {
        var result = [];
        this.itemList.map(function (d, i) {
  ...
  computed: {
    totalFee: function totalFee() {
      ...
      var total = 0;
      this.itemList.map(function (d, i) {
        if (_.indexOf(_this3.result, d.itemid) !== -1) {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      staticStyle: { "background-color": "#fff", "padding-bottom": "50px" }
    },
    [
      _c(
        "div",
        ...
        [
          _c(
            ...
            _vm._l(_vm.itemList, function(item) {
              return _c(
                "van-swipe-cell",
                { key: item.id, attrs: { "right-width": 65 } },
                [
                  _c("div", { staticClass: "cart-item" }, [
                    _c(
                      "div",
                      { staticClass: "checkbox-view" },
                      [_c("van-checkbox", { attrs: { name: item.itemid } })],
                      1
                    ),
                    _vm._v(" "),
                    _c("div", {
                    ...
                    "div",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.onDelete(item.itemid)
                        }
                      },
                      slot: "right"
                    },
