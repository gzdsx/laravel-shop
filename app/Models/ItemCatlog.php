 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\ItemCatlog[] $children
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\ItemCatlog[] $siblings
...
class ItemCatlog extends Model
{
    ...
    protected $fillable = [
        'catid', 'fid', 'name', 'identifier', 'icon', 'displayorder',
    ...
    public static function updateCache()
    {
        ...
        return Cache::forever('itemCatlogs', $items);
    }
    ...
    {
        $data = Cache::get('itemCatlogs', null);
        if (is_null($data)) {
            self::updateCache();
    ...
    {
        return $this->hasMany(ItemCatlog::class, 'fid', 'fid');
    }
}
