...
use App\Models\EcomRefundAddress;
use Illuminate\Http\Request;

trait EcomRefundAddressTrait
{

    /**
     * @return EcomRefundAddress|\Illuminate\Database\Eloquent\Builder
     */
    protected function repository()
    {
        return EcomRefundAddress::query();
    }
