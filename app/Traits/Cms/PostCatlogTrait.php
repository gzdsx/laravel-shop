...
trait PostCatlogTrait
{
    /**
     * @return PostCatlog|\Illuminate\Database\Eloquent\Builder
     */
    protected function query()
    {
        return PostCatlog::query();
    }
    ...
    {
        return ajaxReturn(['items' => PostCatlog::fetchWithCache()]);
    }
